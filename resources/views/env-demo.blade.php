...
<head>
    ...
    <style>
        ...
        .card-header { background-color: var(--theme-color) !important; }
        .btn-theme { background-color: var(--theme-color); border-color: var(--theme-color); color: #fff; }
        .btn-theme:hover { opacity: 0.85; color: #fff; }
    </style>
        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="features">
                    ...
                    <table class="table table-bordered">
                        <thead class="table-light">
                            <tr><th>ENV Variable</th><th>Status</th><th>Effect</th></tr>
                        </thead>
                        <tbody>
                            <tr>
                ...
                <div class="tab-pane fade" id="api">
                    ...
                    <table class="table table-bordered">
                        <thead class="table-light">
                            <tr><th>ENV Variable</th><th>Masked Value</th></tr>
                        </thead>
                        <tbody>
                            <tr>
            ...
            <div class="mt-4 d-flex gap-2">
                <a href="/env-export" class="btn btn-theme">📤 ENV Export Page</a>
                <a href="/cache-demo" class="btn btn-outline-secondary">⚡ Cache Config Demo</a>
            </div>
